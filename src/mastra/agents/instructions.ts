...
2. **ca-[city].justice.fr** (legacy, e.g. ca-besancon.justice.fr, ca-papeete.justice.fr) — only if no modern URL exists in results
...
**Important:** If your first search only returns legacy (ca-[city].justice.fr) or third-party URLs but no cours-appel.justice.fr result, do a second search specifically for the court on cours-appel.justice.fr before using the legacy URL. The modern site has more up-to-date documents.
